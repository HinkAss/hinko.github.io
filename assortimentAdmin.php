  ...
  <body>
    <div class="container"><div class="header_inner">
      <nav class="nav">
          ...
          <a href="admin.php" class='nav_link'>Администрация</a>
      </nav>
  </div>
</div>
    <div class="container">
      <h1 class="name">Tasty pizza assortiment</h1>
        ...
        <tr>
          ...
          <td>
            <a download href="./image/Assortiment/Pizza_1.png" >
              <img class="pizza" src="image/Assortiment/Pizza_1.png" alt="Ням ням">
            </a>
          </td>
          <td>Пикантная пепперони, цыпленок, сыры чеддер и пармезан, моцарелла, соус альфредо</td>
          <td rowspan="2">2300тг</td>
        </tr>
        <tr>
